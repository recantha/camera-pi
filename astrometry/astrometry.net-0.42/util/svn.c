...
static const char* date = "$Date: 2013-03-01 20:29:34 +0000 (Fri, 01 Mar 2013) $";
static const char* url  = "$HeadURL: svn+ssh://astrometry.net/svn/tags/tarball-0.42/astrometry/util/svn.c $";
static const char* rev  = "$Revision: 22330 $";
